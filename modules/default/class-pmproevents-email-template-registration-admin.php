<?php
/**
 * The registration notification email sent to the site administrator.
 *
 * @since 2.0
 */
class PMProEvents_Email_Template_Registration_Admin extends PMProEvents_Email_Template_Registration {
	/**
	...
	public static function get_template_slug() {
		return 'pmpro_events_registration_admin';
	}
	...
	public static function get_template_name() {
		...
		return esc_html( sprintf( __( '%s - Registration Confirmation (admin)', 'pmpro-events' ), pmpro_events_get_label( 'singular' ) ) );
	}
	...
	public static function get_template_description() {
		...
		return esc_html( sprintf( __( 'This email is sent to the site administrator when a member registers for an %s.', 'pmpro-events' ), pmpro_events_get_label( 'singular_lowercase' ) ) );
	}
	...
	public static function get_default_subject() {
		if ( ! class_exists( 'PMPro_Liquid_Renderer' ) ) {
			...
			return esc_html__( 'New registration for !!pmpro_events_event_title!!', 'pmpro-events' );
		}
...
<p><strong>!!pmpro_events_member_display_name!!</strong> (!!pmpro_events_member_email!!) has registered for <strong>!!pmpro_events_event_title!!</strong>.</p>
